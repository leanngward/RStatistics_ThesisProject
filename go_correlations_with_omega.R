...
## Set Up Environment and Variables ####
  ...
  infile <- "branch_model_outputs/branch_output_heliconius_clade.tsv"
  
  #Set go file name
  goterms <- "gpmapping_singlecopy_files/run5_sc_output_orfs_Pfam-A_GO.tsv"
  ...
  #Edit in excel first
  mapfile <- "gomapping_singlecopy_files/unique_go_term_mapping_sc_hmel.txt"
